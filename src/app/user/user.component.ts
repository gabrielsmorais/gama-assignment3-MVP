...
export class UserComponent implements OnInit{
  ...
  [
    ...
    alternatives: [
      ...
      { answer: 'Fala da história da empresa para criar credibilidade e, em seguida, explica a solução detalhadamente.', value: 0 },
      { answer: 'Fala da história da empresa para criar credibilidade, explica detalhadamente a solução, contextualizando qual problema ela resolve.', value: 0 },
    ],
    id: 'question1',
  },
    ...
    alternatives: [
      ...
      { answer: 'Você busca entender o problema dos clientes que não precisam da solução/produto, convence-os de que precisam e consegue vender.', value: 0 },
      { answer: 'Você entende que os clientes se incomodam com vendedores e espera eles demonstrarem interesse na sua solução/produto para fazer a venda; de modo a não incomodar os clientes com abordagens frias.', value: 0 },
    ],
    id: 'question2',
  },
    ...
    alternatives: [
      ...
      { answer: 'Eu nunca desisto do prospect. Quando ele me diz um "Não", eu agendo para voltar a falar com ele depois de um tempo.', value: 0 },
      { answer: 'Eu sou razoável. Eu entro em contato com o prospect e caso ele não responda, eu o respeito e não faço novo contato.', value: 0 },
    ],
    id: 'question3',
  },
    ...
    alternatives: [
      ...
      { answer: 'As leads oriundas do Inbound Marketing, podem não ser suficientes para gerar os resultados que o negócio precisa, por isso, é importante também buscar de forma ativa possíveis clientes', value: 10 },
      { answer: 'A captação ativa de leads é a estratégia que traz mais resultado, entretanto, é importante buscar também fazer um bom inbound marketing e entregar um excelente produto para os clientes para que eles façam indicações e evangelizem o produto.', value: 0 },
    ],
    id: 'question4',
  },
    ...
    alternatives: [
      ...
      { answer: 'A empresa / diversos produtos / perde-perde / na maioria das vezes / da empresa', value: 0 },
      { answer: 'O vendedor / as soluções ideiais / humanizadas / às vezes / dela', value: 0 },
    ],
    id: 'question5',
  },
    ...
    alternatives: [
      ...
      { answer: 'F - F - V - F - F', value: 0 },
      { answer: 'F - V - V - F - V', value: 0 },
      { answer: 'V - V - F - V - F', value: 0 },
    ],
    id: 'question6',
  },
    ...
    alternatives: [
      ...
      { answer: 'Pesquisar no Facebook sobre a vida pessoal do lead e, para criar rapport, citar na ligação o quanto as fotos dele junto com a família na praia ficaram maravilhosas e dizer que você também costuma frequentar essa praia', value: 0 },
      { answer: 'Não ligar, pois você não tem informações suficientes sobre o lead no momento', value: 0 },
      { answer: 'Ligar imediatamente e descobrir as demais informações durante a ligação', value: 0 },
    ],
    id: 'question7',
  },
    ...
    alternatives: [
      ...
      { answer: 'V - V - F - V - F', value: 0 },
      { answer: 'V - F - V - V - F', value: 0 },
      { answer: 'F - F - V - F - V', value: 10 },
    ],
    id: 'question8',
  },
    ...
    alternatives: [
      ...
      { answer: 'A II, pois o assunto é mais assetivo e a conclusão é menos invasiva', value: 0 },
      { answer: 'A II, pois, apesar do assunto menos efetivo, configura-se em uma metodologia consultiva, alinhando-se às tendências de mercado', value: 10 },
    ],
    id: 'question9',
  },
    ...
    alternatives: [
      ...
      { answer: 'Uma simulação do que seria um cliente ideal, usada para direcionar as vendas e a criação de conteúdo.', value: 10 },
      { answer: 'São os prospects da sua empresa.', value: 0 },
      { answer: 'São os clientes que já compraram de sua empresa.', value: 0 },
    ],
    id: 'question11',
  },
